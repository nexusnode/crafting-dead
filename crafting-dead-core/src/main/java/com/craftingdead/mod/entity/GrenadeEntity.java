...
public class GrenadeEntity extends ProjectileItemEntity {
  ...
  public GrenadeEntity(World worldIn, LivingEntity playerIn, GrenadeType type,
      float explosionRadius, float countdown) {
  ...
  protected Explosion explode() {
    ...
    return this.world
        .createExplosion(this, this.getX(), this.getBodyY(0.0625D), this.getZ(), explosionRadius,
            causeFire, mode);
  }
}
