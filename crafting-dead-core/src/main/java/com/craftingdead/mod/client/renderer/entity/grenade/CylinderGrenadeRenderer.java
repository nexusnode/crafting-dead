...
import com.craftingdead.mod.client.renderer.entity.model.CylinderGrenadeModel;
...
public class CylinderGrenadeRenderer extends EntityRenderer<GrenadeEntity> {
  ...
  private final CylinderGrenadeModel model = new CylinderGrenadeModel();

  public CylinderGrenadeRenderer(EntityRendererManager renderManager) {
    super(renderManager);
  }
