...
public class AdvancedZombieModel<T extends AdvancedZombieEntity> extends ZombieModel<T> {
  ...
  public AdvancedZombieModel(float p_i1168_1_, boolean p_i1168_2_) {
    ...
    this.bipedLeftArmwear.addCuboid(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i1168_1_ + 0.25F);
    this.bipedLeftArmwear.setRotationPoint(5.0F, 2.0F, 0.0F);
    this.bipedRightArmwear = new ModelRenderer(this, 40, 32);
    this.bipedRightArmwear.addCuboid(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i1168_1_ + 0.25F);
    this.bipedRightArmwear.setRotationPoint(-5.0F, 2.0F, 10.0F);
    this.bipedLeftLegwear = new ModelRenderer(this, 0, 48);
    this.bipedLeftLegwear.addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i1168_1_ + 0.25F);
    this.bipedLeftLegwear.setRotationPoint(1.9F, 12.0F, 0.0F);
    this.bipedRightLegwear = new ModelRenderer(this, 0, 32);
    this.bipedRightLegwear.addCuboid(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, p_i1168_1_ + 0.25F);
    this.bipedRightLegwear.setRotationPoint(-1.9F, 12.0F, 0.0F);
    this.bipedBodyWear = new ModelRenderer(this, 16, 32);
    this.bipedBodyWear.addCuboid(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, p_i1168_1_ + 0.25F);
  ...
  @Override
  public void setAngles(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_,
