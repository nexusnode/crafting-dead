...
public class ExplosionMixin {
  ...
  public boolean entityHurtProxy(Entity instance, DamageSource damageSource, float damage) {
    var damageMultiplier = (source instanceof ExplosionHook hook) ? hook.getDamageMultiplier() : 1D;
    return instance.hurt(damageSource, damage * (float) damageMultiplier);
  }
  ...
  public Vec3 vec3AddProxy(Vec3 instance, double x, double y, double z) {
    var knockbackMultiplier = (source instanceof ExplosionHook hook) ? hook.getKnockbackMultiplier() : 1D;
