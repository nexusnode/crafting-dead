...
public class GunAnimationReloadM1911 extends GunAnimationReload {
  ...
  public GunAnimationReloadM1911() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadM1911(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.rotate(new Vector3f(-0.5F, 0.5F, -0.5F).rotationDegrees(-progress));
