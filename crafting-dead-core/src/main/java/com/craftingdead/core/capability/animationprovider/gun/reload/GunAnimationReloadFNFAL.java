...
public class GunAnimationReloadFNFAL extends GunAnimationReload {
  ...
  public GunAnimationReloadFNFAL() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadFNFAL(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.rotate(new Vector3f(1.0F, 0.0F, (!ejectingClip ? -1.0F : 0.0F))
