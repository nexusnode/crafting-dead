...
public class ClothingItem extends Item {
  ...
  public void appendHoverText(ItemStack stack, World world, List<ITextComponent> lines,
    ...
    ITextComponent armorLevelText = new StringTextComponent(String.valueOf(this.enhancedProtection))
        .withStyle(TextFormatting.RED);
    lines.add(new TranslationTextComponent("item_lore.clothing.enhanced_protection")
    ...
    if (this.slownessAmplifier != null) {
      ...
      lines.add(new StringTextComponent(potionNameAndLevel).withStyle(TextFormatting.GRAY));
    }
