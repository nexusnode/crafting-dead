...
public class FlashGrenadeEntity extends Grenade {
  ...
  public Integer getMinimumTicksUntilAutoActivation() {
    return CraftingDead.serverConfig.explosivesFlashGrenadeTicksBeforeActivation.get();
  }

  @Override
  public Integer getMinimumTicksUntilAutoDeactivation() {
    return CraftingDead.serverConfig.explosivesFlashGrenadeTicksBeforeDeactivation.get();
  }
