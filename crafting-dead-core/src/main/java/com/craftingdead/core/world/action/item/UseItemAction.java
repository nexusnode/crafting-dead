...
public class UseItemAction extends TimedAction {
  ...
  private UseItemAction(ActionType<?> actionType, LivingExtension<?, ?> performer, LivingExtension<?, ?> target,
  ...
  public static class Builder {
    ...
    public Builder(ActionType<?> actionType, LivingExtension<?, ?> performer, LivingExtension<?, ?> target) {
