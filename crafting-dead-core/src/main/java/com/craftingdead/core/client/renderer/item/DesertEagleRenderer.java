...
public class DesertEagleRenderer extends RenderGun {
  ...
  protected void renderGunFirstPersonAiming(PlayerEntity playerEntity, IGun gun,
    ...
    matrixStack.translate(0.1F, -0.69F, 0.972F);
  ...
  private void renderIronSight1(MatrixStack matrixStack,
    ...
    matrixStack.push();
    {
      ...
      scale = 0.48F;
      matrixStack.scale(scale, scale, scale);
      matrixStack.translate(-0.4F, -0.2F, -0.26F);
      matrixStack.rotate(Vector3f.YP.rotationDegrees(180.0F));
  ...
  private void renderIronSight2(MatrixStack matrixStack,
    ...
    matrixStack.push();
    {
      matrixStack.translate(0.85F, -0.058F, 0.07F);
      float scale = 0.25F;
      matrixStack.scale(scale, scale, scale);
