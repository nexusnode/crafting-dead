...
public class GunAnimationReloadSCARH extends GunAnimationReload {
  ...
  public GunAnimationReloadSCARH() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadSCARH(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    if (!this.ejectingClip) {
      matrixStack.translate(0, (-progress / 300), 0);
    } else {
