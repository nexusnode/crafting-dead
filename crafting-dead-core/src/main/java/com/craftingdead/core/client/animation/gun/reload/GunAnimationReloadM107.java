...
package com.craftingdead.core.client.animation.gun.reload;
...
public class GunAnimationReloadM107 extends GunAnimationReload {
  ...
  public GunAnimationReloadM107() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadM107(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.translate(0.0F, (!ejectingClip ? -(progress / 600) : 0.0F), 0.0F);

    matrixStack.mulPose(new Vector3f((!ejectingClip ? 1.2F : 0.0F), (!ejectingClip ? -0.5F : 0.0F),
        (!ejectingClip ? -1.0F : 0.0F)).rotationDegrees(progress));
    matrixStack.mulPose(new Vector3f(0.0F, (!ejectingClip ? 1.0F : 0.0F),
        (!ejectingClip ? 5.0F : 0.0F)).rotationDegrees(-progress * 0.25F));
  }
