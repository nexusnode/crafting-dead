...
public class GunAnimationReloadHK417 extends GunAnimationReload {
  ...
  public GunAnimationReloadHK417() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadHK417(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.translate(0.0F, (!ejectingClip ? -(progress / 150) : 0.0F),
        (!ejectingClip ? (progress / 300) : 0.0F));
    matrixStack.mulPose(new Vector3f((!ejectingClip ? 1.0F : 0.0F), (!ejectingClip ? -1.0F : 0.0F),
        0.0F).rotationDegrees(progress));
  }
