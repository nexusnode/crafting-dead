...
public class GunAnimationReloadM240B extends GunAnimationReload {
  ...
  public GunAnimationReloadM240B() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadM240B(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.mulPose(new Vector3f((!ejectingClip ? 2.5F : 4.0F), (!ejectingClip ? 1.0F : 0.0F),
