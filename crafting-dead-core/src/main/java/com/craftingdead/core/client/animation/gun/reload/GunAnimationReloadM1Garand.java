...
public class GunAnimationReloadM1Garand extends GunAnimationReload {
  ...
  public GunAnimationReloadM1Garand() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadM1Garand(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.mulPose(new Vector3f((!ejectingClip ? 1.0F : 0.0F), (!ejectingClip ? -0.3F : 0.0F),
        (!ejectingClip ? -0.5F : 0.0F)).rotationDegrees(progress));
    matrixStack
        .mulPose(new Vector3f(0.0F, (!ejectingClip ? 1.0F : 0.0F), (!ejectingClip ? 1.0F : 0.0F))
            .rotationDegrees(-progress * 0.25F));
  }
