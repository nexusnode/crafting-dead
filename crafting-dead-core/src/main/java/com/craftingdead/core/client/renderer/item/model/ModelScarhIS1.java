...
public class ModelScarhIS1 extends Model {
  ...
  public ModelScarhIS1() {
    ...
    Shape1 = new ModelRenderer(this, 15, 15);
    Shape1.addBox(0F, 0F, 0F, 3, 1, 2);
    Shape1.setPos(0.25F, 0F, 0F);
    Shape1.setTexSize(64, 32);
    Shape1.mirror = true;
    setRotation(Shape1, 0F, 0F, 0F);
    Shape2 = new ModelRenderer(this, 8, 15);
    Shape2.addBox(0F, 0F, 0F, 2, 2, 1);
    Shape2.setPos(0F, -1F, 2F);
    Shape2.setTexSize(64, 32);
    Shape2.mirror = true;
    setRotation(Shape2, 0F, 0F, 0F);
    Shape3 = new ModelRenderer(this, 17, 11);
    Shape3.addBox(0F, 0F, 0F, 1, 1, 2);
    Shape3.setPos(0.5F, -0.5F, 0F);
    Shape3.setTexSize(64, 32);
    Shape3.mirror = true;
    setRotation(Shape3, 0F, 0F, 0F);
    Shape4 = new ModelRenderer(this, 26, 15);
    Shape4.addBox(0F, 0F, 0F, 2, 2, 1);
    Shape4.setPos(0F, -1F, -1F);
    Shape4.setTexSize(64, 32);
    Shape4.mirror = true;
    setRotation(Shape4, 0F, 0F, 0F);
    Shape5 = new ModelRenderer(this, 18, 7);
    Shape5.addBox(0F, 0F, 0F, 1, 2, 1);
    Shape5.setPos(0.5F, -2.5F, 0.5F);
    Shape5.setTexSize(64, 32);
    Shape5.mirror = true;
    setRotation(Shape5, 0F, 0F, 0F);
    Shape6 = new ModelRenderer(this, 13, 7);
    Shape6.addBox(0F, 0F, 0F, 1, 1, 1);
    Shape6.setPos(1.5F, -0.5F, 0.5F);
