...
public class GunAnimationReloadMK48 extends GunAnimationReload {
  ...
  public GunAnimationReloadMK48() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadMK48(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.translate(0.0F, (!ejectingClip ? -(progress / 100) : 0.0F),
        (!ejectingClip ? (progress / 50) : 0.0F));
    matrixStack.mulPose(new Vector3f((!ejectingClip ? 1.5F : 4.0F), (!ejectingClip ? 1.0F : 0.0F),
        (!ejectingClip ? 2.0F : 1.0F)).rotationDegrees(-progress));
