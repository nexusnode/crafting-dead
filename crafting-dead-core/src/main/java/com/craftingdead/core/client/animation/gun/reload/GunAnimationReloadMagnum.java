...
public class GunAnimationReloadMagnum extends GunAnimationReload {
  ...
  public GunAnimationReloadMagnum() {
    this.ejectingClip = true;
    trans1 = 0F;
  }

  public GunAnimationReloadMagnum(boolean par1) {
  ...
  public void doRender(ItemStack par1, float par2, MatrixStack matrixStack) {
    ...
    matrixStack.translate(0.0F, -(progress / 150), 0.0F);

    matrixStack.mulPose(new Vector3f(-1.0F, 1.0F, 0.5F).rotationDegrees(-progress));
    matrixStack.mulPose(new Vector3f(1.0F, 0.0F, -0.5F).rotationDegrees(progress));
  }
