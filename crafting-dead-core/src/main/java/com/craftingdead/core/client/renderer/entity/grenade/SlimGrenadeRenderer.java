...
public class SlimGrenadeRenderer extends EntityRenderer<Grenade> {

  private final ModelPart model;

  public SlimGrenadeRenderer(EntityRendererProvider.Context context) {
    super(context);
    this.model = context.bakeLayer(ModModelLayers.SLIM_GRENADE);
  }
