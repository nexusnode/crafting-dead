...
public class FlaskItem extends EatItem {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn,
        ...
        if(worldIn.getFluidState(blockpos).isTagged(FluidTags.WATER) && itemstack.getItem() == ModItems.flaskEmpty) {
            return new ActionResult<>(ActionResultType.SUCCESS, this.turnSwapItem(itemstack, playerIn, new ItemStack(ModItems.flask)));
        }
