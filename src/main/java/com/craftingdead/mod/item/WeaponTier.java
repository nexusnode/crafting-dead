...
public enum WeaponTier implements IItemTier {
  ...
  /**
   * Production level. For example: Wood 0, Stone 1, Iron 2, Diamond 3, Gold 0
   */
  ...
  private WeaponTier(int harvestLevelIn, int maxUsesIn, float efficiencyIn, float attackDamageIn,
