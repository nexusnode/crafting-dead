...
import com.craftingdead.mod.common.entity.monster.EntityCDZombieFast;
import com.craftingdead.mod.common.entity.monster.EntityCDZombieTank;
import com.craftingdead.mod.common.entity.monster.EntityCDZombieWeak;
...
public class EntityRegistry {
	...
	private static EntityEntry buildZombie(String registryName, int id, Class<? extends EntityCDZombie> zombieType,
		...
		return startBuilding(registryName, id).entity(zombieType).tracker(64, 3, false).egg(0x000000, 0xFFFFFF)
				.spawn(EnumCreatureType.MONSTER, spawnWeight, spawnMin, spawnMax, WorldRegistry.getZombieBiomes())
				.build();
	}
