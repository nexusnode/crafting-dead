...
public class GuiCDContainerList extends GuiCDContainer {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		if(textHeight > this.height) {
			...
			RenderHelper.drawRectangle(this.posX + this.width - 18, this.posY + 4, this.scollerBox.width - 6, this.height - 7, 0x000000, 1.0F);
			RenderHelper.drawImage(this.scollerBox.x, this.scollerBox.y, new ResourceLocation(CraftingDead.MOD_ID, "textures/gui/scoller.png"), this.scollerBox.width, this.scollerBox.height, 1.0F);
		}
