...
public abstract class ItemRenderer extends ItemStackTileEntityRenderer implements IUnbakedModel, IBakedModel {
	...
	protected abstract void renderItem(ItemStack stack, ItemCameraTransforms.TransformType transformType);
	...
	protected abstract void bakeModels(ModelBakery bakery, Function<ResourceLocation, TextureAtlasSprite> spriteGetter);
}
