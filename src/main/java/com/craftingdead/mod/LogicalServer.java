...
public abstract class LogicalServer {
	...
	protected abstract boolean verifyHandshake(CMessageHandshake handshakeMessage);
	...
	void login(EntityPlayerMP entityPlayer) {
		CraftingDead.NETWORK_WRAPPER.sendTo(new SMessageRequestHandshake(), entityPlayer);
	...
	public void onHandshake(EntityPlayerMP entity, CMessageHandshake handshakeMessage) {
