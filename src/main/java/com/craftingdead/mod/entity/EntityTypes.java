...
public class EntityTypes {
	...
	public static void handle(RegistryEvent.Register<EntityType<?>> event) {
		event.getRegistry().registerAll( //
				EntityType.Builder.create(CorpseEntity::new, EntityClassification.MISC) //
						.setTrackingRange(64) //
						.setUpdateInterval(10) //
						.setShouldReceiveVelocityUpdates(false) //
						.build(new ResourceLocation(CraftingDead.MOD_ID, "entity_corpse").toString()) //
						.setRegistryName(new ResourceLocation(CraftingDead.MOD_ID, "entity_corpse")));
	}
}
