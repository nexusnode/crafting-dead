 ...
 */
 ...
 public class DecorationBlocks {
   ...
   public static final RegistryObject<Block> ABANDONED_CAMPFIRE_POT =
	         deferredRegister.register("abandoned_campfire_pot",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.WOOD, MaterialColor.PODZOL)
	                     ...
	                     .sound(SoundType.WOOD)
	                     .noOcclusion(),
	                 BlockShapes.ABANDONED_CAMPFIRE_POT));

   public static final RegistryObject<Block> AMMO_BOX_BULLETS =
   deferredRegister.register("ammo_box_bullets",
   () -> new OrientableBlock(
       Block.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY)
           .strength(2.0F)
           .sound(SoundType.METAL)
           .noOcclusion(),
       BlockShapes.AMMO_BOX_BULLETS));

   public static final RegistryObject<Block> MILITARY_BED_WITH_GUN =
	         deferredRegister.register("military_bed_with_gun",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.WOOL, MaterialColor.COLOR_GRAY)
	                     .strength(2.0F)
	                     .sound(SoundType.WOOL)
	                     .noOcclusion(),
	                 BlockShapes.MILITARY_BED));
   
   public static final RegistryObject<Block> MILITARY_BED_WITH_BOX =
   ...
   public static final RegistryObject<Block> MILITARY_BED_FUNGI =
   ...
   public static final RegistryObject<Block> MILITARY_BED_FRAME =
   ...
   public static final RegistryObject<Block> MILITARY_BED =
   ...
   public static final RegistryObject<Block> MATTRESS_3 =
	         deferredRegister.register("mattress_3",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.WOOL, MaterialColor.COLOR_GRAY)
	                     ...
	                     .sound(SoundType.WOOL)
	                     .noOcclusion(),
	                 BlockShapes.MATTRESS_3));
   
   public static final RegistryObject<Block> MATTRESS_2 =
	         deferredRegister.register("mattress_2",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.WOOL, MaterialColor.COLOR_GRAY)
	                     ...
	                     .sound(SoundType.WOOL)
	                     .noOcclusion(),
	                 BlockShapes.MATTRESS_2));
   
   public static final RegistryObject<Block> MATTRESS_1 =
	         ...
	         deferredRegister.register("generator",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY)
	                     ...
	                     .sound(SoundType.METAL)
	                     .noOcclusion(),
	                 BlockShapes.GENERATOR));
   
   public static final RegistryObject<Block> BREAKER_BOX_1 =
	         deferredRegister.register("breaker_box_1",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.METAL, MaterialColor.COLOR_GRAY)
	                     ...
	                     .sound(SoundType.METAL)
	                     .noOcclusion(),
	                 BlockShapes.BREAKER_BOX));
	 
	     public static final RegistryObject<Block> BREAKER_BOX_2 = 
	     ...
	     public static final RegistryObject<Block> BREAKER_BOX_3 = 
	     ...
	     public static final RegistryObject<Block> BREAKER_BOX_4 =
	     ...
	     public static final RegistryObject<Block> BREAKER_BOX_5 =
	     ...
	     public static final RegistryObject<Block> BODY_PART_1 =
	         deferredRegister.register("body_part_1",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.WOOD, MaterialColor.PODZOL)
	                     ...
	                     .sound(SoundType.WOOD)
	                     .noOcclusion(),
	                 BlockShapes.BODY_PART_1));
	 
	     public static final RegistryObject<Block> BODY_PART_2 =
	         deferredRegister.register("body_part_2",
	             () -> new OrientableBlock(
	                 Block.Properties.of(Material.WOOD, MaterialColor.PODZOL)
	                     ...
	                     .sound(SoundType.WOOD)
	                     .noOcclusion(),
	                 BlockShapes.BODY_PART_2));
	 
	     public static final RegistryObject<Block> BODY_PART_3 =
