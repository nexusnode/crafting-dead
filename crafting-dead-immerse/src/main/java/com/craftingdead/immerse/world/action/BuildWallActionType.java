...
public class BuildWallActionType extends BlueprintActionType {

  private final Supplier<Block> block;

  protected BuildWallActionType(Builder builder) {
    super(builder);
  ...
  protected BlueprintAction create(LivingExtension<?, ?> performer, BlockPlaceContext context) {
    return new BuildWallAction(performer, context, this);
  }
  ...
  public static class Builder extends BlueprintActionType.Builder<Builder> {
    ...
    public ItemActionType<?> build() {
      return new BuildWallActionType(this);
    }
  }
}
