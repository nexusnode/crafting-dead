...
public class MainMenuView extends ParentView {
  ...
  public MainMenuView() {
    ...
    rankView.addChild(new TextView(new Properties())
        .setText(GuiUtil.translatable("view.main_menu.rank")));
    ...
    menuBar.addChild(this.createButton(
        ...
        () -> ((MinecraftViewScreen) this.getScreen()).keepOpenAndSetScreen(
            new OptionsScreen(((MinecraftViewScreen) this.getScreen()), minecraft.options))));
    ...
    var fakePlayerEntity = new FakePlayer(user.getGameProfile());
        ...
        .flatMap(gateway -> gateway.getGameProfileFeed()
            ...
            .doOnNext(role -> {
              ...
              this.roleTextView.setText(
                  newRole == null ? StyledText.EMPTY : StyledText.of(newRole.name()));
            }))
        .subscribe();
  }
  ...
  private View createButton(ResourceLocation imageLocation, Properties properties,
      Component tooltip, Runnable actionListener) {
  ...
  private View createButton(@Nullable String containerId, ResourceLocation imageLocation,
      Properties properties, Component tooltip, Runnable actionListener) {
    var buttonContainer =
    ...
    tooltipView
        .addChild(new TextView(new Properties()).setText(AdapterUtil.createStyledText(tooltip)));
  ...
  public static Screen createScreen() {
    var screen = new MinecraftViewScreen(TITLE, new MainMenuView());
