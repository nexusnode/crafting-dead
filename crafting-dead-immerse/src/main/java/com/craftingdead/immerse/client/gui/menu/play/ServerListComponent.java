...
public class ServerListComponent extends ContainerComponent {
  ...
  private Component<?> controlsContainer(ContainerComponent listContainer) {
    return new ContainerComponent()
        ...
        .addChild(new ContainerComponent()
            .addChild(new TextBlockComponent(new TranslationTextComponent("menu.play.server_list.button.refresh"))
                .setShadow(false)
                .setHeight(8F))
            .setJustifyContent(Justify.CENTER)
            .setAlignItems(Align.CENTER)
        ...
        .addChild(new ContainerComponent()
            .addChild(new TextBlockComponent(new TranslationTextComponent("menu.play.server_list.button.play"))
                .setShadow(false)
                .setHeight(8F))
            .setJustifyContent(Justify.CENTER)
            .setAlignItems(Align.CENTER)
  ...
  private Component<?> firstTableRow() {
    return new ContainerComponent()
            ...
            .setFlexDirection(FlexDirection.ROW)
            .setAlignItems(Align.CENTER)
            .addChild(new TextBlockComponent(new TranslationTextComponent("menu.play.server_list.server"))
                .setFlexGrow(1F)
                .setShadow(false)
                .setCentered(true)
                .setHeight(8))
            .addChild(new TextBlockComponent(new TranslationTextComponent("menu.play.server_list.ping"))
                ...
                .setLeftMargin(10F)
                .setHeight(8))
            .addChild(new TextBlockComponent(new TranslationTextComponent("menu.play.server_list.players"))
                .setWidth(60F)
                .setShadow(false)
                .setCentered(true)
                .setLeftMargin(10F)
  ...
  private void connectToSelected(ParentComponent<?> parent) {
    parent.getChildrenComponents().stream()
        .filter(component -> component instanceof ServerItemComponent && ((ServerItemComponent) component).isSelected())
        .findFirst()
  ...
  private void loadServers(ContainerComponent listContainer) {
    ...
    try {
      ...
      logger.warn("Unable to load server list from {} - {}", file.getAbsolutePath(), e.getMessage());
      return;
    }
  }
