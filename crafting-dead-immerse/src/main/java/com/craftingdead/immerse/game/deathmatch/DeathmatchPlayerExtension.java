...
public class DeathmatchPlayerExtension implements IPlayerExtension {
  ...
  public DeathmatchPlayerExtension(DeathmatchGame game, IPlayer<?> player) {
    this(game, player, 0, 0, 0);
  }

  public DeathmatchPlayerExtension(DeathmatchGame game, IPlayer<?> player, int buyTimeSeconds,
