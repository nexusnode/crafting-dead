...
public class SurvivalServer extends SurvivalGame implements GameServer {
  ...
  public static final Codec<SurvivalServer> CODEC = RecordCodecBuilder.create(instance -> instance
      .group(
          ThirstProperties.CODEC.optionalFieldOf("thirst", ThirstProperties.DEFAULT)
  ...
  public SurvivalServer(ThirstProperties thirstProperties,
      boolean killFeedEnabled) {
    super(thirstProperties.enabled());
