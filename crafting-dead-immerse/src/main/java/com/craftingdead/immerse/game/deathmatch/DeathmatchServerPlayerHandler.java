...
public class DeathmatchServerPlayerHandler extends DeathmatchPlayerHandler {
  ...
  public DeathmatchServerPlayerHandler(DeathmatchServer game, PlayerExtension<?> player) {
  ...
  public boolean onAttacked(DamageSource source, float amount) {
    ...
    if (source.getEntity() instanceof PlayerEntity) {
      ...
      if (LivingExtension.getOptional(playerEntity)
          ...
          .map(extension -> ((DeathmatchPlayerHandler) extension).getTeam().orElse(null) == this
              .getTeam().orElse(null))
          .orElse(false)) {
        return true;
      }
  ...
  public void copyFrom(PlayerExtension<?> that, boolean wasDeath) {
    DeathmatchServerPlayerHandler extension =
        (DeathmatchServerPlayerHandler) that.getExpectedHandler(ID);
    if (extension.valid) {
