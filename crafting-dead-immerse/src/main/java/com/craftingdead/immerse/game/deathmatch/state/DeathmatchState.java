...
public enum DeathmatchState implements State<DeathmatchServer> {
  ...
  private final BiFunction<DeathmatchState, DeathmatchServer, ? extends StateInstance<DeathmatchServer>> stateFactory;

  private DeathmatchState(
      BiFunction<DeathmatchState, DeathmatchServer, ? extends StateInstance<DeathmatchServer>> stateFactory) {
    this.stateFactory = stateFactory;
  }

  @Override
  public StateInstance<DeathmatchServer> newInstance(DeathmatchServer context) {
